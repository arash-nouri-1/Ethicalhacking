...
from nmap.portscan import scanHost
...
class NetCat:
    ...
    def handle(self, client_socket):
        if self.args.execute:
            ...
            scanHost(self.args.target, 1, 1000)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--target', default='192.168.137.130', help='specified IP')
    parser.add_argument('-u', '--upload', help='upload file')
    parser.add_argument('-k', '--keylog', help='log keys')
    parser.add_argument('-n', '--nmap', help='scan ports')
